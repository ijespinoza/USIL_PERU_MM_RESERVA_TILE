		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Gestion Reserva Tile",
									"targetURL": "#comindragestionreservatile-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comindragestionreservatile-display": {
								"semanticObject": "comindragestionreservatile",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.indra.gestionreservatile",
									"url": sap.ui.require.toUrl("com/indra/gestionreservatile")
								}
							}
						}
					}
